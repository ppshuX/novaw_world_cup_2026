...
球队名片资料也存放在 `src/data/teams.ts`。它只是轻量辅助信息，不维护完整球员数据库；主教练等未确认字段会显示“待补充”，后续可人工补充。当前球队简介补充了小组赛场次和 FIFA 资料口径世界杯参赛次数这类低维护信息；“代表球星”只用于快速识别球队，不等同于官方最终名单或首发预测。官方资料入口指向 FIFA Teams 页面。
