...
**当前版本：V1.0.0（已收官）** · [更新日志](./CHANGELOG.md)

**在线访问**：[https://ppshu2026-6hz4s01hv.maozi.io/](https://ppshu2026-6hz4s01hv.maozi.io/)

<img width="211" height="232" alt="cc6fc2b37138968b8a8891b924cc8b63" src="https://github.com/user-attachments/assets/2dc777b7-4039-4fc7-bf63-74210efb9976" />

> 🏆 **2026世界杯已圆满结束** · 2026年6月11日 — 7月20日 · 104场比赛 · 48支球队 · **西班牙荣耀夺冠** 🇪🇸
>
> 决赛：西班牙 1:0 阿根廷（MetLife Stadium, New York/New Jersey）· 三四名：英格兰 6:4 法国
...
V1 功能范围已冻结，全部 104 场比赛数据已同步完毕，世界杯赛程维护已正式结束。网站保留作为 2026 世界杯的完整赛程档案。
...
- 移动端底部筛选抽屉
- 比赛详情弹窗
- 本地比赛收藏：只保存 match id，不做账号同步
- 轻量球队名片：展示国旗、队名、小组、一句话简介和待补充资料
- Bracket 晋级路径页
- 当前为空树 / 占位树，不提前填写胜者或冠军
- Sources 数据来源页
- 官方 FIFA 页面入口
- 数据反馈 / 纠错反馈邮箱入口
- 观赛信息入口：电视端可先关注 CCTV-5，具体每场以赛前官方节目单为准
...
球队名片资料也存放在 `src/data/teams.ts`。它只是轻量辅助信息，不维护完整球员数据库；主教练、代表球星、参赛次数等内容按人工维护资料填充，后续若官方信息变化可继续更正。“代表球星”只用于快速识别球队，不等同于官方最终名单或首发预测。官方资料入口指向 FIFA Teams 页面。
