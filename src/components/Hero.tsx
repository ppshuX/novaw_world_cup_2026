              ...
              <>
                ...
                >
                  <div className="grid grid-cols-[1fr_auto_1fr] items-center gap-3">
                    ...
                    <span className={`rounded-[8px] px-2 py-1.5 text-xs font-black sm:px-3 sm:py-2 sm:text-sm ${getResolvedMatchStatusLabel(nextMatch) === '未开始' ? 'bg-white text-[#172033]' : `${getStatusColorClasses(nextMatch).bg} ${getStatusColorClasses(nextMatch).text}`}`}>
